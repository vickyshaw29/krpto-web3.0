  ...
  return (
    <Grid container className={styles.footerContainer} alignItems="center">
      <Grid item container alignItems="center">
        ...
        <Grid item container xs={9} alignItems="center" justifyContent="space-around">
          <Grid item>
      ...
      <Grid item container justifyContent="space-between">
          <Grid item>
              <Typography variant="body2" style={{marginTop:10}}>@customKrypto 2022</Typography>
          </Grid>
          <Grid item>
              <Typography variant="body2" style={{marginTop:10}}>All rights reserved</Typography>
          </Grid>
      </Grid>
    </Grid>
  );
